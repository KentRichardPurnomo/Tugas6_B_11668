...
model = load_model(r"D:\Atma\Sem 5\Pembelajaran Mesin\P8\Tugas6_B_11668\model_mobilenet.h5")
...
# Streamlit UI
st.title("Prediksi Kematangan Buah Naga - 1668")  # 4 digit npm terakhir
    ...
    if uploaded_files:
        ...
        for uploaded_file in uploaded_files:
            ...
            if label != "Error":
                ...
                for i, class_name in enumerate(zip(class_names)):
